/**
 * GameOver — Game over screen with score, retry, and revive options
 * Extracted from component `e8` (lines 10449–10648)
 * 
 * Displays "SYSTEM FAILURE" with stats, optional ad-based revive,
 * retry button, and back-to-menu button.
 */
 ...
 * 
 * Features:
 * - "SYSTEM FAILURE" header with red neon glow
 * - Level stats (kills, combo, coins, score)
 * - Optional ad-based revive (full HP continue)
...
export function GameOver() {
  ...
  /** Start watching a rewarded ad to revive */
  const handleWatchAd = useCallback(() => {
    if (isWatchingAd) return;
    setIsWatchingAd(true);
    setAdProgress(0);
    // Simulate ad — in production this calls the ad SDK
    // ey.getInstance().showRewardedAdWithCallbacks(...)
          ...
          >
            <div>
              <div
                ...
                style={{ color: COLORS.red, textShadow: '0 0 10px #ff3333' }}
              >
                REVIVE
              </div>
              <div
        ...
        <div className="my-auto w-full py-6">
          ...
          <h1
            ...
            style={{
              color: COLORS.red,
              textShadow:
                '0 0 20px #ff3333, 0 0 40px #ff3333, 0 0 80px #ff0000',
          ...
          <p
            ...
            style={{ color: COLORS.cyan, textShadow: '0 0 8px #00ffff' }}
          >
            LEVEL {currentLevel}
          </p>
              ...
              <>
                <button
                  ...
                  style={{
                    ...
                    background:
                      'linear-gradient(135deg, rgba(255,215,0,0.15), rgba(255,100,0,0.1))',
